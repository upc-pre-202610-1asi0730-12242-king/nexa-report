...
- **Diego Yucra (Scrum Master):** Lideró la delimitación del MVP y redactó el inventario inicial de Historias de Usuario.
...
- **Gerard Rojas (Architecture Lead):** Desarrolló el modelado de dominio colaborativo (EventStorming) e inicializó los repositorios en GitHub.
...
- **Diego Yucra (Scrum Master):** Lideró la maquetación y desarrollo en código de la Landing Page y participó en las entrevistas logísticas.
...
- **Gerard Rojas (Architecture Lead):** Modeló la estructura de Base de Datos relacional y elaboró los diagramas arquitectónicos C4 (Contexto y Contenedores).
